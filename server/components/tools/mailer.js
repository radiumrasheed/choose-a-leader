...
exports.sendConfirmationSMS = function(phone, email, next) {
  var __message = 'Congratulations, Your NBA 2016 e-Voting accreditation is complete. You can now login to the portal.';
...
exports.sendUpdatedRecordsToEmail = function(firstname,phone, email, next) {
  var _message = "Dear "+firstname+", Your Details Have been Updated successfully and this Phone Number: "+phone+" has been added to your NBA E-voting Portal Account, thank you for updating your records";
  ...
  async.parallel([
    function (cb) {
      if (email!=undefined && email!=null) {
        var newMessage = _message;
        newMessage.html = html_message;
        newMessage.subject = 'Record Updated. [NBA 2016 e-VOTING Portal]';
        newMessage.to = [email];
    ...
    console.info("Confirmation Sent to Email for Record Update ", results);
    return;
  });
};

exports.sendUpdatedRecordsToPhone = function(message,phone, next) {
  ...
  async.parallel([
    ...
    console.info("Confirmation Sent to Phone for Record Update  ", results);
    return;
  });
};

exports.sendUpdatedRecordsToBoth = function(firstname,phone, email, next) {
  var __message = "Dear "+firstname+", Your Details Have been Updated successfully and this email "+email+"  and Phone Number: "+phone+" has been added to your NBA E-voting Portal Account, thank you for updating your records.";
